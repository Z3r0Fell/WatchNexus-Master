...
const MenuPage = () => {
  ...
  const fetchRequests = useCallback(async () => {
    ...
    } catch { console.error('[MenuPage] Failed to fetch requests'); toast.error('[MenuPage] Failed to fetch requests');; }
  }, [filter]);
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      setStats(res.data);
    } catch { console.error('[MenuPage] Failed to fetch stats'); toast.error('[MenuPage] Failed to fetch stats');; }
  }, []);
