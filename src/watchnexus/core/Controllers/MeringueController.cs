...
public class MeringueController : ControllerBase
{
    ...
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "meringue", version = "2.9.0", status = "active", description = "Media request system: users request movies/TV shows, admins approve" });
