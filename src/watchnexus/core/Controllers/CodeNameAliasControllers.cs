...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "sorbet", name = "Weather Dashboard", version = "2.9.0", status = "active", route = "/api/gadgets/weather", description = "Weather dashboard powered by Open-Meteo" });
    [HttpGet("{**path}")]
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "brioche", name = "Podcasts", version = "2.9.0", status = "active", route = "/api/gadgets/podcasts", description = "Podcast player with iTunes search and RSS feeds" });
    [HttpGet("{**path}")]
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "nectar", name = "Internet Radio", version = "2.9.0", status = "active", route = "/api/gadgets/radio", description = "Live radio streams via Radio Browser API" });
    [HttpGet("{**path}")]
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "ganache", name = "Photo Gallery", version = "2.9.0", status = "active", route = "/api/gadgets/photos", description = "Browse and view photos from local libraries" });
    [HttpGet("{**path}")]
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "bisque", name = "Web Video", version = "2.9.0", status = "active", route = "/api/gadgets/webvideo", description = "Web video bookmarks, history, and YouTube info" });
    [HttpGet("{**path}")]
...
public class MarzipanController : ControllerBase
{
    ...
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "marzipan", name = "Playlists & Collections", version = "2.9.0", status = "active",
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "cinnamon", name = "Synapse Admin", version = "2.9.0", status = "active", route = "/api/gadgets/synapse-admin", description = "Synapse homeserver user, room, and media management" });
    [HttpGet("{**path}")]
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "waffle", name = "Movie Quiz", version = "2.9.0", status = "active", route = "/api/gadgets/gamebot", description = "Guess-the-poster games with blur and reveal effects" });
    [HttpGet("{**path}")]
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "custard", name = "Media Bridge", version = "2.9.0", status = "active", route = "/api/gadgets/media-bridge", description = "Browse and manage your external Emby-compatible media server library" });
    [HttpGet("{**path}")]
...
{
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "yeast", name = "Background Automation", version = "2.9.0", status = "active", route = "/api/gadgets/bot", description = "Inactivity checks, token drip, and featured film rotation" });
    [HttpGet("{**path}")]
...
public class GlazeController : ControllerBase
{
    ...
    {
        module = "glaze", version = "2.9.0", status = "active",
...
public class SetupWizardController : ControllerBase
{
    ...
    public async Task<IActionResult> Status()
    {
        ...
        return Ok(new { module = "setup", version = "2.9.0", completed, requires_setup = !completed });
    }
