...
public class RipenController : ControllerBase
{
    ...
    [HttpGet("status")]
    public IActionResult Status() => Ok(new { module = "ripen", version = "1.0.1", status = "active", description = "Plugin marketplace and gadget management" });

    private static readonly List<Dictionary<string, string>> AllGadgets = new()
    {
        new() { ["gadget_id"] = "weather", ["codename"] = "sorbet", ["name"] = "Weather", ["version"] = "1.0.1", ["category"] = "weather", ["description"] = "Weather dashboard powered by Open-Meteo" },
        new() { ["gadget_id"] = "podcasts", ["codename"] = "brioche", ["name"] = "Podcasts", ["version"] = "1.0.1", ["category"] = "audio", ["description"] = "Podcast player with iTunes search and RSS feeds" },
        new() { ["gadget_id"] = "radio", ["codename"] = "nectar", ["name"] = "Internet Radio", ["version"] = "1.0.1", ["category"] = "audio", ["description"] = "Live radio streams via Radio Browser API" },
        new() { ["gadget_id"] = "photos", ["codename"] = "ganache", ["name"] = "Photo Gallery", ["version"] = "1.0.1", ["category"] = "image", ["description"] = "Browse and view photos from local libraries" },
        new() { ["gadget_id"] = "webvideo", ["codename"] = "bisque", ["name"] = "Web Video", ["version"] = "1.0.1", ["category"] = "video", ["description"] = "Web video bookmarks, history, and YouTube info" },
        new() { ["gadget_id"] = "matrix", ["codename"] = "marzipan", ["name"] = "Matrix Chat", ["version"] = "1.0.1", ["category"] = "notification", ["description"] = "Matrix messaging, room management, and event sync" },
        new() { ["gadget_id"] = "synapse-admin", ["codename"] = "cinnamon", ["name"] = "Synapse Admin", ["version"] = "1.0.1", ["category"] = "system", ["description"] = "Synapse homeserver user, room, and media management" },
        new() { ["gadget_id"] = "gamebot", ["codename"] = "waffle", ["name"] = "Movie Quiz", ["version"] = "1.0.1", ["category"] = "game", ["description"] = "Guess-the-poster games with blur and reveal effects" },
        new() { ["gadget_id"] = "media-bridge", ["codename"] = "custard", ["name"] = "Media Bridge", ["version"] = "1.0.1", ["category"] = "metadata", ["description"] = "Browse and manage your external Emby-compatible media server library" },
        new() { ["gadget_id"] = "bot", ["codename"] = "yeast", ["name"] = "Background Automation", ["version"] = "1.0.1", ["category"] = "service", ["description"] = "Inactivity checks, token drip, and featured film rotation" },
        new() { ["gadget_id"] = "truffle", ["codename"] = "truffle", ["name"] = "Watch Analytics", ["version"] = "1.0.1", ["category"] = "analytics", ["description"] = "Play tracking, viewing stats, trends, and Year Wrapped" },
        new() { ["gadget_id"] = "pepper", ["codename"] = "pepper", ["name"] = "Notification Hub", ["version"] = "1.0.1", ["category"] = "notification", ["description"] = "Discord, Telegram, Slack, and Pushover alerts for media events" },
        new() { ["gadget_id"] = "meringue", ["codename"] = "meringue", ["name"] = "User Requests", ["version"] = "1.0.1", ["category"] = "social", ["description"] = "Users request movies/TV shows, admins approve or reject" },
        new() { ["gadget_id"] = "rind", ["codename"] = "rind", ["name"] = "Parental Controls", ["version"] = "1.0.1", ["category"] = "security", ["description"] = "Content rating filters, PIN locks, and per-user restrictions" },
        new() { ["gadget_id"] = "crucible", ["codename"] = "crucible", ["name"] = "Media Processing", ["version"] = "1.0.1", ["category"] = "processing", ["description"] = "FFmpeg transcoding, H.265 conversion, subtitle extraction, and file analysis" },
        new() { ["gadget_id"] = "brine", ["codename"] = "brine", ["name"] = "Usenet Indexer", ["version"] = "1.0.1", ["category"] = "usenet", ["description"] = "Search NZBs via Prowlarr or Newznab-compatible indexers" },
        new() { ["gadget_id"] = "ladle", ["codename"] = "ladle", ["name"] = "Usenet Downloader", ["version"] = "1.0.1", ["category"] = "usenet", ["description"] = "SABnzbd queue management, downloads, history, and speed control" },
        new() { ["gadget_id"] = "glaze", ["codename"] = "glaze", ["name"] = "Scrobbling", ["version"] = "1.0.1", ["category"] = "social", ["description"] = "Trakt.tv and Last.fm scrobbling, watch history sync" },
        new() { ["gadget_id"] = "fondue", ["codename"] = "fondue", ["name"] = "Movie Automation", ["version"] = "1.0.1", ["category"] = "automation", ["description"] = "Auto-grab, monitor, and upgrade movies (Radarr-like)" },
        new() { ["gadget_id"] = "bastion", ["codename"] = "bastion", ["name"] = "Advanced Auth", ["version"] = "1.0.1", ["category"] = "security", ["description"] = "LDAP, SSO, 2FA, and session management" },
        new() { ["gadget_id"] = "tunnel", ["codename"] = "tunnel", ["name"] = "Network Config", ["version"] = "1.0.1", ["category"] = "system", ["description"] = "Reverse proxy, UPnP, SSL certificates, and dynamic DNS" },
        new() { ["gadget_id"] = "sourdough", ["codename"] = "sourdough", ["name"] = "Backup & Restore", ["version"] = "1.0.1", ["category"] = "system", ["description"] = "Full backups, scheduled snapshots, config export/import" },
        new() { ["gadget_id"] = "taffy", ["codename"] = "taffy", ["name"] = "Metadata Agents", ["version"] = "1.0.1", ["category"] = "metadata", ["description"] = "TMDB, TVDB, IMDb, MusicBrainz provider management" },
        new() { ["gadget_id"] = "churro", ["codename"] = "churro", ["name"] = "Download Clients", ["version"] = "1.0.1", ["category"] = "downloads", ["description"] = "qBittorrent, SABnzbd, Transmission, Deluge client management" },
        new() { ["gadget_id"] = "saffron", ["codename"] = "saffron", ["name"] = "Scheduled Tasks", ["version"] = "1.0.1", ["category"] = "system", ["description"] = "Library scans, metadata refresh, cleanup, and custom schedules" },
        new() { ["gadget_id"] = "pantry", ["codename"] = "pantry", ["name"] = "Storage Manager", ["version"] = "1.0.1", ["category"] = "system", ["description"] = "Disk monitoring, file cleanup, path mappings, storage analytics" },
        new() { ["gadget_id"] = "nutmeg", ["codename"] = "nutmeg", ["name"] = "Recommendations", ["version"] = "1.0.1", ["category"] = "discovery", ["description"] = "AI-powered recommendations based on watch history" },
    };
