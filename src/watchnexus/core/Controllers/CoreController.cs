...
public class CoreController : ControllerBase
{
    ...
    public IActionResult Info()
    {
        ...
        var builtIn = new[]
        {
            new { name = "Marmalade", codename = "marmalade", version = "1.0.3", status = "active" },
            new { name = "Bastion", codename = "bastion", version = "1.0.3", status = "active" },
            new { name = "Tunnel", codename = "tunnel", version = "1.0.3", status = "active" },
            new { name = "Zest", codename = "zest", version = "1.0.3", status = "active" },
            new { name = "Fondue", codename = "fondue", version = "1.0.3", status = "active" },
            new { name = "Sorbet", codename = "sorbet", version = "1.0.3", status = "active" },
            new { name = "Brioche", codename = "brioche", version = "1.0.3", status = "active" },
            new { name = "Nectar", codename = "nectar", version = "1.0.3", status = "active" },
            new { name = "Ganache", codename = "ganache", version = "1.0.3", status = "active" },
            new { name = "Bisque", codename = "bisque", version = "1.0.3", status = "active" },
            new { name = "Marzipan", codename = "marzipan", version = "1.0.3", status = "active" },
            new { name = "Cinnamon", codename = "cinnamon", version = "1.0.3", status = "active" },
            new { name = "Waffle", codename = "waffle", version = "1.0.3", status = "active" },
            new { name = "Yeast", codename = "yeast", version = "1.0.3", status = "active" },
            new { name = "Sourdough", codename = "sourdough", version = "1.0.3", status = "active" },
            new { name = "Taffy", codename = "taffy", version = "1.0.3", status = "active" },
            new { name = "Churro", codename = "churro", version = "1.0.3", status = "active" },
            new { name = "Saffron", codename = "saffron", version = "1.0.3", status = "active" },
            new { name = "Pantry", codename = "pantry", version = "1.0.3", status = "active" },
            new { name = "Nutmeg", codename = "nutmeg", version = "1.0.3", status = "active" },
            new { name = "Crumbs", codename = "crumbs", version = "1.0.3", status = "active" },
            new { name = "Fortress", codename = "fortress", version = "1.0.3", status = "active" },
            new { name = "Custard", codename = "custard", version = "1.0.3", status = "active" },
            new { name = "Truffle", codename = "truffle", version = "1.0.3", status = "active" },
            new { name = "Pepper", codename = "pepper", version = "1.0.3", status = "active" },
            new { name = "Meringue", codename = "meringue", version = "1.0.3", status = "active" },
            new { name = "Rind", codename = "rind", version = "1.0.3", status = "active" },
            new { name = "Crucible", codename = "crucible", version = "1.0.3", status = "active" },
            new { name = "Brine", codename = "brine", version = "1.0.3", status = "active" },
            new { name = "Ladle", codename = "ladle", version = "1.0.3", status = "active" },
            new { name = "Ripen", codename = "ripen", version = "1.0.3", status = "active" },
            new { name = "Glaze", codename = "glaze", version = "1.0.3", status = "active" },
            new { name = "Roux", codename = "roux", version = "1.0.3", status = "active" },
            new { name = "Sprout", codename = "sprout", version = "1.0.3", status = "active" },
            new { name = "Setup Wizard", codename = "setup", version = "1.0.3", status = "active" },
        };
