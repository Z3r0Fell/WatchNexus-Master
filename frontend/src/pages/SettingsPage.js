                ...
                {loadingUsers ? (
                  ...
                  <div className="space-y-3">
                    {users.map((user) => (
                      <div
                        key={user.id}
                        className="p-4 rounded-xl bg-surface border border-white/10 hover:border-violet-500/30 transition-colors"
                      >
                            ...
                            >
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <label className="flex items-center gap-2 text-sm">
                                  <Switch
                                    ...
                                    onCheckedChange={(v) => handleUpdateUser(user.id, {
                              ...
                              <div className="mt-3">
                                ...
                                <Input
                                  ...
                                  onChange={(e) => handleUpdateUser(user.id, {
          ...
          <TabsContent value="library">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
              ...
              <div className="flex gap-2 border-b border-white/10 pb-4">
                ...
                >
                  <FolderCog className="w-4 h-4 inline mr-2" />
                  Media Management
                </button>
                <button
                ...
                >
                  <FolderInput className="w-4 h-4 inline mr-2" />
                  Manual Import
                </button>
              </div>
              ...
              {librarySubTab === 'libraries' && (
                <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded-lg bg-violet-500/20 flex items-center justify-center text-violet-400">
                                  {lib.media_type === 'movies' && <Film className="w-5 h-5" />}
                                  {lib.media_type === 'tv' && <Tv className="w-5 h-5" />}
                                  {lib.media_type === 'music' && <Music className="w-5 h-5" />}
                                  {lib.media_type === 'audiobooks' && <Book className="w-5 h-5" />}
                                  {!['movies', 'tv', 'music', 'audiobooks'].includes(lib.media_type) && <Folder className="w-5 h-5" />}
                                </div>
                                <div>
                              ...
                              <div className="flex items-center gap-2">
                                <span className="text-sm text-gray-400">{lib.item_count || 0} items</span>
                                <Button
                                  variant="ghost"
                                  size="sm"
                  ...
                  {/* Tips */}
                  <div className="glass-card rounded-xl p-6">
                    <h3 className="font-bold mb-4">Tips & Guidelines</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              ...
                              <Button
                                type="button"
                                onClick={() => {
                                  openFileBrowser(mediaManagement.recycling_bin || '/');
                                }}
                                className="bg-violet-600 hover:bg-violet-700 px-3"
                                title="Browse folders"
                              >
