...
import org.jellyfin.mobile.downloads.WatchNexusDownloadService
...
suspend fun MainActivity.removeDownload(download: LocalWatchNexusMediaSource, force: Boolean = false) {
    if (!force) {
    ...
    DownloadService.sendRemoveDownload(
        this,
        WatchNexusDownloadService::class.java,
        contentId,
        false,
    )
