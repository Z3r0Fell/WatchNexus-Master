...
class MediaSourceResolver(private val apiClient: ApiClient) {
    ...
    suspend fun resolveMediaSource(
    ...
    ): Result<RemoteWatchNexusMediaSource> {
            ...
            val response = withContext(Dispatchers.IO) {
                mediaInfoApi.getPostedPlaybackInfo(
                    ...
                    data = PlaybackInfoDto(
                        ...
                        // https://github.com/jellyfin/jellyfin/blob/9a35fd673203cfaf0098138b2768750f4818b3ab/WatchNexus.Api/Helpers/MediaInfoHelper.cs#L196-L201
        ...
        // Create WatchNexusMediaSource
        return try {
            val source = RemoteWatchNexusMediaSource(
                itemId = itemId,
                item = item,
            ...
            Timber.e(e, "Cannot create WatchNexusMediaSource")
