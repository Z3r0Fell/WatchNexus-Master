...
class WatchNexusMediaSourceSerializer : KSerializer<LocalWatchNexusMediaSource> {
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("WatchNexusMediaSource") {
    ...
    override fun serialize(encoder: Encoder, value: LocalWatchNexusMediaSource): Unit =
    ...
    @SuppressWarnings("MagicNumber")
    override fun deserialize(decoder: Decoder): LocalWatchNexusMediaSource =
