...
class WebViewFragment : Fragment(), BackPressInterceptor, WatchNexusWebChromeClient.FileChooserListener {
    ...
    private lateinit var jellyfinWebViewClient: WatchNexusWebViewClient
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        jellyfinWebViewClient = object : WatchNexusWebViewClient(
            lifecycleScope,
            server,
            assetsPathHandler,
            apiClientController,
    ...
    private fun WebView.initialize() {
        ...
        webChromeClient = WatchNexusWebChromeClient(this@WebViewFragment)
