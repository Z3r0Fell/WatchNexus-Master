...
fun SearchTextInput(
	...
	val color = when {
		focused -> WatchNexusTheme.colorScheme.inputFocused to WatchNexusTheme.colorScheme.onInputFocused
		else -> WatchNexusTheme.colorScheme.input to WatchNexusTheme.colorScheme.onInput
	}
