...
object ListControlDefaults {
	...
	@Composable
	fun colors(
		containerColor: Color = WatchNexusTheme.colorScheme.listButton,
		focusedContainerColor: Color = WatchNexusTheme.colorScheme.listButtonFocused,
	) = ListControlColors(
...
fun ListControl(
	...
	Box(
		...
		ListItemContent(
			...
			headingStyle = WatchNexusTheme.typography.listHeadline
				.copy(color = WatchNexusTheme.colorScheme.listHeadline),
		)
	}
}
