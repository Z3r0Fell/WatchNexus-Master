...
object SeekbarDefaults {
	...
	@Composable
	fun colors(
		backgroundColor: Color = WatchNexusTheme.colorScheme.rangeControlBackground,
		bufferColor: Color = WatchNexusTheme.colorScheme.seekbarBuffer,
		progressColor: Color = WatchNexusTheme.colorScheme.rangeControlFill,
		knobColor: Color = WatchNexusTheme.colorScheme.rangeControlKnob,
	) = SeekbarColors(
