...
SELECT      kodi_id, kodi_fileid, kodi_pathid, parent_id, media_type,
            watchnexus_type, media_folder, watchnexus_parent_id
FROM        watchnexus
WHERE       watchnexus_id = ?
"""
get_item_obj = ["{Id}"]
...
get_item_by_parent = """
SELECT      watchnexus_id, kodi_id, kodi_fileid
FROM        watchnexus
WHERE       parent_id = ?
AND         media_type = ?
"""
get_item_by_media_folder = """
SELECT      watchnexus_id, watchnexus_type
FROM        watchnexus
WHERE       media_folder = ?
"""
...
FROM        watchnexus
WHERE       watchnexus_id LIKE ?
"""
get_item_by_wild_obj = ["{Id}"]
get_item_by_kodi = """
SELECT      watchnexus_id, parent_id, media_folder, watchnexus_type, checksum
FROM        watchnexus
WHERE       kodi_id = ?
AND         media_type = ?
"""
get_checksum = """
SELECT      watchnexus_id, checksum
FROM        watchnexus
WHERE       watchnexus_type = ?
"""
get_view_name = """
SELECT      view_name
FROM        view
...
"""
get_media_by_id = """
SELECT      watchnexus_type
FROM        watchnexus
WHERE       watchnexus_id = ?
"""
get_media_by_parent_id = """
SELECT      watchnexus_id, watchnexus_type, kodi_id, kodi_fileid
FROM        watchnexus
WHERE       watchnexus_parent_id = ?
"""
get_view = """
SELECT      *
FROM        view
...
add_reference = """
INSERT OR REPLACE INTO      watchnexus(watchnexus_id, kodi_id, kodi_fileid, kodi_pathid, watchnexus_type,
                            media_type, parent_id, checksum, media_folder, watchnexus_parent_id)
VALUES                      (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
"""
