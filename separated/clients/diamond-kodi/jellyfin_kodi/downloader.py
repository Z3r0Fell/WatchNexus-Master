...
def get_watchnexusserver_url(handler):
...
def _http(action, url, request=None, server_id=None):
    ...
    return WatchNexus(server_id).http.request(request)


def _get(handler, params=None, server_id=None):
    return _http("GET", get_watchnexusserver_url(handler), {"params": params}, server_id)


def _post(handler, json=None, params=None, server_id=None):
    return _http(
        "POST",
        get_watchnexusserver_url(handler),
...
def _delete(handler, params=None, server_id=None):
    return _http(
        "DELETE", get_watchnexusserver_url(handler), {"params": params}, server_id
    )
