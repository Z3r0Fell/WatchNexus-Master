...
from .watchnexus.connection_manager import CONNECTION_STATE
...
class Connect(object):
    ...
    def register(self, server_id=None, options={}):
        ...
        try:
            WatchNexus(server_id).start(True)
    ...
    def get_user(self, client):
        """Save user info."""
        self.user = client.watchnexus.get_user()
    ...
    def select_servers(self, state=None):
        ...
        dialog = ServerConnect("script-watchnexus-connect-server.xml", *XML_PATH)
        dialog.set_args(
    ...
    def manual_server(self, manager=None):
        ...
        dialog = ServerManual("script-watchnexus-connect-server-manual.xml", *XML_PATH)
    ...
    def login(self):
        ...
        dialog = UsersConnect("script-watchnexus-connect-users.xml", *XML_PATH)
    ...
    def login_manual(self, user=None, manager=None):
        ...
        dialog = LoginManual("script-watchnexus-connect-login-manual.xml", *XML_PATH)
        dialog.set_args(
            **{
