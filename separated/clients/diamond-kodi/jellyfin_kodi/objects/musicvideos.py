...
class MusicVideos(KodiDb):
    ...
    def musicvideo(self, item, e_item):
        ...
        If we don't get the track number from WatchNexus, see if we can infer it
    ...
    def musicvideo_add(self, obj):
        ...
        self.watchnexus_db.add_reference(*values(obj, QUEM.add_reference_mvideo_obj))
        LOG.debug(
    ...
    def remove(self, item_id, e_item):
        """Remove mvideoid, fileid, pathid, watchnexus reference."""
        obj = {"Id": item_id}
