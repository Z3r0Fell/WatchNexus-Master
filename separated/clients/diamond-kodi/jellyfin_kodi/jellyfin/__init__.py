...
from .client import WatchNexusClient
...
class WatchNexus(object):
    """This is your WatchNexusclient, you can create more than one. The server_id is only a temporary thing
    to communicate with the WatchNexusClient().

    from watchnexus_kodi.watchnexus import WatchNexus

    WatchNexus('123456').config.data['app']

    # Permanent client reference
    client = WatchNexus('123456').get_client()
    ...
    def __setattr__(self, name, value):
        ...
        if has_attribute(self, name):
            return super(WatchNexus, self).__setattr__(name, value)
    ...
    def construct(self):
        ...
        self.client[self.server_id] = WatchNexusClient()
