...
WatchNexus started with 8 modules. By version 2.9.0, it had 35. The sidebar navigation, which initially listed every module as a flat list, became unusable around module 15. We needed a system that could:
...
*WatchNexus is a self-hosted media management pipeline at version 2.9.0. Built with React 18, TailwindCSS, and Shadcn UI.*
