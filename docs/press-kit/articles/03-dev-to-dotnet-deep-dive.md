...
The codebase is at version 1.0.1. The .NET 10 foundation has held up well -- the performance characteristics, the deployment story, and the ecosystem (EF Core, ASP.NET Core) were the right fit for this problem space.

---

*WatchNexus is a self-hosted media management pipeline. Version 1.0.1 release builds are available for Linux x64 and Windows x64.*
